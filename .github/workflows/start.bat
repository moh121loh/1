...
& "${Env:PROGRAMFILES(X86)}\Google\Chrome Remote Desktop\CurrentVersion\remoting_start_host.exe" --code="4/0AdQt8qhTofV2Z4j96_CDoChh08TyouR7Uds2qcH0pWKhACZml-6-j20vZ0O6q8iiLWX7gQ" --redirect-url="https://remotedesktop.google.com/_/oauthredirect" --name=$Env:COMPUTERNAMEecho  Successful installation !, If RDP is dead, please rebuild again! 
echo IP:
